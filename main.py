...
async def buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "start_bidding":
        ...
        await query.message.edit_text("اختر الطرنيب الأساسي لمزاودتك:", reply_markup=kb)
        ...
        await query.message.edit_text("اختر البدلة لإضافة أوراق يدك:", reply_markup=kb)
